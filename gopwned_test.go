...
const (
	...
	DATACLASSES  = "[\"Addresses\",\"Age groups\",\"Career levels\",\"Credit cards\",\"Customer interactions\",\"Dates of birth\",\"Device usage tracking data\",\"Education levels\",\"Email addresses\",\"Email messages\",\"Employers\",\"Ethnicities\",\"Genders\",\"Geographic location\",\"Government issued IDs\",\"Historical passwords\",\"Instant messenger identities\",\"IP addresses\",\"Job titles\",\"MAC addresses\",\"Names\",\"Nicknames\",\"Passport numbers\",\"Password hints\",\"Passwords\",\"Payment histories\",\"Phone numbers\",\"Private messages\",\"Purchases\",\"Races\",\"Relationship statuses\",\"Reward program balances\",\"Salutations\",\"Security questions\",\"Sexual preferences\",\"SMS messages\",\"Social connections\",\"Spoken languages\",\"Time zones\",\"User website URLs\",\"Usernames\",\"Website activity\",\"Years of birth\"]"
)
